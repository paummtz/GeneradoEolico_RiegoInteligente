...
# Dentro de Directions.py
import Functions as CallMethood
import GlobalInfo.ResponseMessages as ResponseMessage
...
def index():
    return {
        "status": "success",
        "message": "La API de Riego Inteligente está funcionando correctamente",
        "version": "1.0.0",
